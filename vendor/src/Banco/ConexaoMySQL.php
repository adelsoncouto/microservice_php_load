...
class ConexaoMySQL { 
	...
	public static function getInstance() { 
		if (!isset(self::$instance)) { 
			self::$instance = new PDO('mysql:host=;dbname=load;port=3306', '', '', array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8")); 
	 ...
	 * @param int $aId o id do objeto
	 * @param object $aObjeto o objeto
	 * @param string $aTabela a tabela se não informado será usado o nome da
	 * classe
	 */
